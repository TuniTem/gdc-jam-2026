...
func _create_characters() -> Array[CharacterData]:
	...
	policeman.lines = [
		"I'm looking for an expedition bouquet.",
		"That book over there should help you figure it out.",
	...
	soccermom.lines = ["Its my sons birthday"]
	...
	grampa.lines = ["Its my wife and my 40th aniversty"]
	...
	richguy.lines = ["Its a normal friday"]
	...
	parkingattendant.lines = ["My life sucks"]
