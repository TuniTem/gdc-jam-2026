...
func _create_characters() -> Array[CharacterData]:
	...
	policeman.portrait = load("res://Assets/bad-placeholder-human.png")
	...
	soccermom.portrait = load("res://Assets/bad-placeholder-human.png")
	...
	grampa.portrait = load("res://Assets/bad-placeholder-human.png")
	...
	richguy.portrait = load("res://Assets/bad-placeholder-human.png")
	...
	parkingattendant.portrait = load("res://Assets/bad-placeholder-human.png")
