...
func _ready():
	...
	flower_to_count_map[load("res://resources/ButterFlower.tres")] = 99
	# flower_to_count_map[load("res://resources/CactusFlower.tres")] = 30
	flower_to_count_map[load("res://resources/DevilsFlower.tres")] = 99
	flower_to_count_map[load("res://resources/IceFlower.tres")] = 99
	
	flower_to_count_map[load("res://resources/FireworkFlower.tres")] = 99
	flower_to_count_map[load("res://resources/SilkweedFlower.tres")] = 99
	
	flower_to_count_map[load("res://resources/NectarFlower_1.tres")] = 99
	flower_to_count_map[load("res://resources/NectarFlower_2.tres")] = 99
	flower_to_count_map[load("res://resources/NectarFlower_3.tres")] = 99
	flower_to_count_map[load("res://resources/SpikeFlower.tres")] = 99
